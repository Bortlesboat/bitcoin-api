...
The result is **Satoshi API** -- 34 endpoints, FastAPI, typed responses, and analyzed data instead of raw RPC dumps. It's [open source](https://github.com/Bortlesboat/bitcoin-api) and on PyPI as `bitcoin-api`.
