...
The result is **Satoshi API** -- FastAPI, typed responses, and fee intelligence instead of raw RPC dumps. It's [open source](https://github.com/Bortlesboat/bitcoin-api) and on PyPI as `satoshi-api`.
