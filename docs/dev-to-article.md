...
Apache-2.0 licensed, 139 unit tests + 21 E2E tests (160 total), CI pipeline. If you run a node and want a clean API on top of it, I'd love feedback — open an issue or drop a comment below.
