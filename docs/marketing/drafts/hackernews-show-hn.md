...
Satoshi API wraps Bitcoin Core's JSON-RPC in a REST interface with 74 endpoints. `pip install satoshi-api`, set your RPC credentials, and you have a local API on port 9332.
...
Solo project. 335 unit tests, 21 e2e tests. Apache-2.0 license. Feedback appreciated.
