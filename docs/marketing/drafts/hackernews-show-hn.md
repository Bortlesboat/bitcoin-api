...
That is the core use case. There are 76 endpoints total (blocks, transactions, mempool, mining stats, address lookups, real-time SSE streams), but the fee intelligence is what is actually differentiated.
