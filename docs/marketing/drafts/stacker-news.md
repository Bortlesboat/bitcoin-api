...
`pip install satoshi-api` and you have fee intelligence from your own node -- know when to send, what to pay, and whether to wait. Apache-2.0 licensed. Everything stays local.
