...
### 1.1 Core API Endpoints (73 total across 20 routers)
...
| **Interactive guide** | `/api/v1/guide` -- use-case filtering, multi-language code examples (Python, curl, JS), covers all 73 endpoints |
