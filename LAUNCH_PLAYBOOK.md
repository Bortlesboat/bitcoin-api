...
| 3 | **r/selfhosted** (Sun 10am ET) | "Self-hosted Bitcoin fee intelligence API -- save money on every transaction" | `docs/marketing/drafts/reddit-selfhosted.md` |
...
Fee intelligence from your own node. pip install. Self-hosted or hosted free tier.
